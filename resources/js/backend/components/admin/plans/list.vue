<template>
    <div>
        ...
        <div class="breadcrumbs-area">
            <h3>Plans Comition</h3>
            <ul>
                <li>
                    <router-link :to="{ name: 'Dashboard' }">Home</router-link>
                </li>
                <li>Plans Comition</li>
            </ul>
        </div>
        <div class="card">
            <div class="card-body">
...
export default {
    ...
    created() {
        this.fields =  [
                ...
                { key: 'comission_rate', label: 'Comission Rate', sortable: true },
                { key: 'start_balance', label: 'Start Balance', sortable: true },
                { key: 'end_balance', label: 'End Balance', sortable: true },
                { key: 'totalorder', label: 'Total Task', sortable: true },
    ...
    methods: {
        ...
        async UserList(auto = false) {
            this.tableloader = true
                ...
                var res = await this.callApi('get', `/api/admin/plan?type=d`, []);
                this.items = res.data
